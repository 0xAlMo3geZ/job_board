    ...
    <div class="py-10 px-6">
        <div class="max-w-sm mx-auto py-10 px-6 bg-gray-100 rounded-xl">
            ...
            <form v-on:submit.prevent="submitForm">
                ...
                <input v-model="password1" type="password" placeholder="Your password..."
                    class="w-full mb-4 py-4 px-6 rounded-xl">
                <input v-model="password2" type="password" placeholder="Repeat password..."
                    class="w-full mb-4 py-4 px-6 rounded-xl">
                ...
                <button class="py-4 px-6 bg-cyan-700 text-white rounded-xl">Submit</button>
            </form>
        </div>
    </div>
</template>